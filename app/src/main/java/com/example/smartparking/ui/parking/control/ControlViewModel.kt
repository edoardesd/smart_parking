...
//    var mqttManager: MQTTManager? = null
    ...
    private var mqttClient = MqttAndroidClient(context, serverURI, uniqueID)
//    var mqttManager: MQTTManager? = null
    init {
        connect()
...
//        txt_control.text = message.toString()
        ...
        Log.d(TAG, "Image decoded.")
           var tmpBitmap : Bitmap = BitmapFactory.decodeByteArray(decodedImageBytes, 0, decodedImageBytes.size)
