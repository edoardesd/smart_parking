...
class ProfEngineeringBubble: BubbleInterface {
    ...
    override fun getMyBubbles(): ArrayList<BubbleListModel> {
        ...
        listBubbles.add(BubbleListModel("Infopoint", R.drawable.info, CrowdLevel.values().random(), 9.minutes))
        ...
        listBubbles.add(BubbleListModel("Printers", R.drawable.print, CrowdLevel.values().random(), 1.minutes))
